...
class Barter62 extends StatefulWidget {
  const Barter62({Key key}) : super(key: key);

  @override
  _Barter62State createState() => _Barter62State();
}

class _Barter62State extends State<Barter62> {
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset("assets/images/undraw2.png"),
            ),
            Container(
              padding: EdgeInsets.only(bottom: 10, top: 50),
              child: Text("Discover And Chat",
                  style: TextStyle(
                      color: AppColors.pinkColor,
                      fontSize: 24,
                      fontWeight: FontWeight.bold)),
